...
const MP4ToGIFComponent = () => {
  ...
  return (
    <div className="container mt-5">
      <h2 className="mb-4 text-center">MP4 to GIF Converter</h2>
      ...
      {gif && (
        <div className="text-center mt-4">
          ...
          />
          <div className="mt-2">
            <a href={gif} download="converted-image.gif" className="btn btn-success">
              Download GIF
            </a>
          </div>
        </div>
...
export default MP4ToGIFComponent;
